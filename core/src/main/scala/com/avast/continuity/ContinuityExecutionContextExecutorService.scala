...
class ContinuityExecutionContextExecutorService(ec: ExecutionContextExecutorService)(implicit threadNamer: ThreadNamer) extends ExecutionContextExecutorService {
